...
def consolidate_station_data():
    """Consolide les données des stations de vélo de Paris et Nantes."""
    con = duckdb.connect(database = "data/duckdb/mobility_analysis.duckdb", read_only = False)
    data = {}
    ...
    # Traitement des données de Nantes
    data = {}
...
def consolidate_station_statement_data():
    """Consolide les données d'état des stations de vélos pour Paris et Nantes."""
    con = duckdb.connect(database = "data/duckdb/mobility_analysis.duckdb", read_only = False)
